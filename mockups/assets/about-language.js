// Retain the existing About page translations with the shared language control.
(() => {
  var translations = {
    ...
    '沿革': 'History',
    '1932（昭和7年）': '1932',
    '初代・加藤徳松が陶磁器熱板の製造を開始。': 'The first-generation proprietor, Tokumatsu Kato, began manufacturing ceramic heating plates.',
    '1951（昭和26年）': '1951',
    '戦後、1947年の貿易再開を受け、主に米国向けの陶磁器人形の製作を中心とする輸出メーカーへ転換（テーケー名古屋人形製陶株式会社）。': 'Following the postwar resumption of trade in 1947, the business shifted to manufacturing porcelain dolls for export, primarily to the United States, as TK Nagoya Ningyo Seitoh Co., Ltd.',
    '陶製レース人形をはじめ、カントリー雑貨・アロマポット・招福製品へと製品を拡大。': 'Expanded the range to include porcelain lace dolls, country decor, aroma pots, and lucky charms.',
    '2013〜2020年': '2013–2020',
    'ウォルト・ディズニー社、サンリオ社、不二家などのキャラクターを中心に、陶製レースを施した作品を製作。': 'Created pieces adorned with porcelain lace, primarily featuring characters from Walt Disney, Sanrio, Fujiya and others.',
    ...
    '原型制作': 'Creating the Original Model',
  ...
  function translate() {
    const root = document.querySelector('.about-main');
    if (!root) return;
    ...
    while ((node = walker.nextNode())) {
      ...
      node.nodeValue = document.documentElement.lang === 'en' && translations[key] ? original.replace(key, translations[key]) : original;
    }
  }
  document.addEventListener('kmn:languagechange', translate);
  translate();
})();

...
(function () {
  ...
  Object.assign(translations, {"新商品": "New Arrivals", "作品ギャラリー": "Gallery", "新商品を見る": "Explore New Arrivals", "陶に咲く、": "Lace blooms", "レース。": "in porcelain.", "愛知県瀬戸市から、手仕事の美しさを。": "The beauty of handcraft, from Seto, Japan.", "繊細な陶のレースを、暮らしへ。": "Delicate porcelain lace, made for your home.", "1951年から受け継ぐ手仕事": "Handcrafted since 1951", "愛知県瀬戸市の窯元": "Made in Seto, Aichi", "暮らしに、陶の美しさを。": "The beauty of porcelain, at home.", "新商品と、おすすめの作品": "New Arrivals & Selected Works", "オンラインショップへ": "Explore the Online Shop", "作品を見る": "View the Work", "プリンス＆プリンセス": "Prince & Princess", "白磁のプードル": "White Porcelain Poodles", "ルミナス ドーナッツパンダ ティポット": "Luminous Donut Panda Teapot", "オンライン販売の準備を進めています。掲載写真は作品のご紹介です。": "Our online shop is being prepared. These photographs introduce our work.", "このレースは、": "This delicate lace", "陶でできています。": "is made of porcelain.", "ふわりと広がるドレス。": "A dress that softly unfolds.", "幾重にも重なる、繊細なレース。": "Layers of intricate lace.", "その優美な表情をかたちにするのは、": "Its graceful form is shaped by", "瀬戸で受け継いできた陶磁器づくりの技術。": "the ceramic traditions passed down in Seto.", "ひとつひとつに、職人の手仕事が息づいています。": "Each piece carries the touch of its maker.", "作品をじっくり見る": "Discover the Details", "暮らしを彩る、陶のかたち。": "Porcelain for Everyday Beauty", "すべての写真を見る": "Explore the Gallery", "アン王女の上絵付け": "Painting Princess Anne", "和装の陶磁器人形": "Porcelain Doll in Kimono", "工房の手仕事": "At the Atelier", "瀬戸の工房から。": "From Our Seto Atelier.", "土と手と炎がつくる、静かな美しさ。": "Quiet beauty, shaped by clay, hands and fire.", "昭和26年、輸出向けの陶磁器人形づくりから始まった私たちの歩み。原型づくりから上絵付けまで、ひとつの作品に、いくつもの手仕事を重ねています。": "Our story began in 1951, making porcelain dolls for export. From sculpting the original form to painting the final details, each piece passes through many careful hands.", "作品との出会いを、オンラインショップで。": "Discover our work in the online shop.", "卸・法人のお取引についてもご相談ください。": "We also welcome wholesale and business enquiries.", "陶の表情と、手仕事の風景。写真を選んで、細部までご覧ください。": "Porcelain expressions and scenes from the atelier. Select a photograph to explore the details.", "作品の分類": "Filter works", "すべて": "All", "陶磁器の作品": "Porcelain Works", "暮らしに迎える、陶の美しさ。": "Welcome Porcelain into Your Home.", "Shopifyストアで見る": "Visit the Shopify Store", "陶に咲く、レース。｜KM名古屋ドール株式会社": "Lace in Porcelain | KM Nagoya Doll", "作品ギャラリー｜KM名古屋ドール株式会社": "Gallery | KM Nagoya Doll", "陶製レース人形の写真を拡大": "Enlarge Porcelain lace doll", "アン王女の上絵付けの写真を拡大": "Enlarge Painting Princess Anne", "プリンス＆プリンセスの写真を拡大": "Enlarge Prince & Princess", "白磁のプードルの写真を拡大": "Enlarge White Porcelain Poodles", "和装の陶磁器人形の写真を拡大": "Enlarge Porcelain Doll in Kimono", "工房の手仕事の写真を拡大": "Enlarge At the Atelier"});
